...
@listableObjectComponent('PublicationSearchResult', ViewMode.ListElement, Context.Any, 'montreal')
@listableObjectComponent(ItemSearchResult, ViewMode.ListElement, Context.Any, 'montreal')
@Component({
